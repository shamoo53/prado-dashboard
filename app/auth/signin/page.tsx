...
import { Eye, EyeOff, Shield, Zap, ArrowLeft } from "lucide-react"
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Access your humanitarian crowdfunding dashboard</CardDescription>
          </CardHeader>
